...
const MarkerMap = () => {
    ...
    const handleChangeViewState = ({ viewport }) => setViewport(viewport);
    ...
    return (
        <div>
            ...
            {/*    onClick={(info, event) => console.log("On layer clicked", info, event)}*/}
            {/*>*/}
            {/*    {isGlobeView ? (*/}
            ...
            >
                ...
                {/*<DeckGL layers={layers} viewState={viewport}></DeckGL>*/}
                <DeckGL
                    width={"100vw"}
                    height={"100vh"}
                    layers={layers}
