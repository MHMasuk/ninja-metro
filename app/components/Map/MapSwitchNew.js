    ...
    return (
        <div className="relative min-h-screen">
            <Map
                ...
                onDblClick={handleMarkerAddClick}
            ...
            >
                ...
                {markerCoordinates ?
                    ...
                    >
                        Data
                        <button className="bg-teal-200" style={{zIndex: 200}} onClick={() => console.log("Maker botom click.")}>New button</button>
                    </Marker> : null
                }
